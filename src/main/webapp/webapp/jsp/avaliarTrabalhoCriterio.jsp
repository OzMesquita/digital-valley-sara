...
<%@ page import="br.com.n2s.sara.model.*" %>
                      ...
                      <section class="panel">
                        ...
                        <table class="table table-striped table-advance table-hover">
	                        ...
	                        <input type="hidden" value="<%=trabalho.getIdTrabalho() %>" name="t-a" >
				                    ...
				                    <tr>
				                    	<h2>Crit�rio Inicial</h2>
				                    	<p>O resumo est� identificado? (Caso esteja identificado, o resumo deve ser rejeitado)</p>
				                    	<div class="input-group form-row">
				                 			<div class="input-group-prepend col">
    											<div class="input-group-text col">	    											
					                    	 	 		<button onclick="ativa()">Resumo N�O est� identificado</button>					                    	 	 		     	  										
	  													<button onclick="desativa()">Resumo est� identificado</button>	  												
  												</div>
  											</div>	
				                    </tr>
				                    ...
				                    <tr>
				                   	...
				                   	<tr>
				                   		<br><br><br>
				                   		<p>*Descreva abaixo suas considera��es sobre o trabalho:</p> 
                     	...
                     	<button type="submit" onclick="myFunction();" class="btn btn-primary">Enviar Avalia��o</button>
                     </form>
                  </div>
              </div>
         </section>
  ...
  <!-- container section start -->
    ...
    <!-- javascripts -->
    <!-- Este � o script para calcular a nota -->
    <script>
			function ativa(){
				console.log("socorro");
	 ...
	 <script>
			function myFunction() {
				...
				alert("A nota para o trabalho �: "+nota/cont);
			}
		</script>
