...
<section id="main-content">
	<section class="wrapper">
		...
		<div class="row">
			<div class="col-lg-12">
				<section class="panel">
					<header class="panel-heading"> Formulário de Edição do Evento </header>
							...
							<form action="EditarEvento" method="post" id="formEnviar">
								<div class="form-validate form-horizontal" id="feedback_form">
									<div class="form-group ">
										...
										<div class="col-lg-6">
											<input class="form-control " id="nome" type="text" name="nome" required value="<%=evento.getNome()%>" />
										</div>
									</div>
									...
									<div class="form-group ">
										<label for="cemail" class="control-label col-lg-2">Data Inicial <span class="required">*</span>
										</label>
										<div class="col-lg-6">
									...
									<div class="form-group">
										<label for="ccomment" class="control-label col-lg-2">Tipo do Evento
											<span class="required">*</span>
										</label>
										<div class="col-lg-10">
