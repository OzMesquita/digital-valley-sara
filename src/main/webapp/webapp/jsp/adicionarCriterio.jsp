						...
						<div class="form">
							<form action="AdicionarCriterio" method="post" id = "formEnviar">
								<div class="form-validate form-horizontal" id="feedback_form">
									...
									<div class="form-group">
										<label for="ccomment" class="control-label col-lg-2">Descrição</label>
										<div class="col-lg-10">
											<textarea class="form-control " id="ccomment" name="descricaoCriterio"></textarea>
										</div>
									</div>
									...
									<div class="form-group ">
										...
										<div class="col-lg-6">
											<input class="form-control " id="subject" type="number" value="0" name="pesoCriterio" required />
										</div>
									</div>
