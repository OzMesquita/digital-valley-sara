...
public class Submissao extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String tipoApresentacaoString = request.getParameter("apresentacao");
			
			if(tipoApresentacaoString != null) {
				trabalho.setTipoApresentacao(TipoApresentacao.valueOf(tipoApresentacaoString));
			}
			...
			File dir = new File(util.Constantes.getArticlesDir() + File.separator + nomeEvento.getIdEvento()
					+ File.separator + nomeTrilha.getIdTrilha() + File.separator + "versaoFinal" + File.separator);
			...
			for (Part part : request.getParts()) {
				...
				String nome = dia + "_" + mes + "_" + ano + "_" + hora + "_" + minuto + "_" + segundo
